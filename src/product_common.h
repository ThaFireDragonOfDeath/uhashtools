...
#define UHASHTOOLS_RC_FILEVERSION          0,4,0,1
#define UHASHTOOLS_RC_FILEVERSION_STR      L"0.4.0.1-SNAPSHOT\0"
#define UHASHTOOLS_RC_FILEFLAGS            (VS_FF_PRERELEASE | VS_FF_DEBUG)
#define UHASHTOOLS_RC_PRODUCTVERSION       0,4,0,0
#define UHASHTOOLS_RC_PRODUCTVERSION_STR   L"0.4.0-SNAPSHOT\0"
